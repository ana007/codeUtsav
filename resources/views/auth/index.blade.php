                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="data-align-right">
                                        ...
                                        <a href="{{ URL::to('admin/register/getregister') }}" class="btn add-row btn-primary">Add Vendor</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table foo-data-table-filterable" data-filter="#filter" data-filter-text-only="true" data-page-size="5" data-limit-navigation="3">
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="td-right"><a class="row-edit" href="{{{ URL::to('admin/register/' . $user->id . '/edit' ) }}}"><span class="zmdi zmdi-edit"></span></a> <a href="{{{ URL::to('admin/register/' . $user->id . '/delete' ) }}}" onclick="return confirm('Are you sure you want to delete this code?');"><span class="zmdi zmdi-hc-lg zmdi-delete"></span></a></td>
                                </tr>
                            @endforeach
                            </tbody>
